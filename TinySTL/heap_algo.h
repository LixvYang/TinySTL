...
namespace tinystl
{
  ...
  void push_heap_aux(RandomIter first, Distance holdIndex, Distance topIndex, T value)
  {
    auto parent = (holdIndex - 1) / 2;
  ...
  {
    tinystl::push_heap_aux(first, (last - first) - 1, static_cast<Distance>(*(last - 1)));
  }
